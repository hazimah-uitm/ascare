    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Tambah Dana Zakat</li>
            </ol>
        </nav>
    </div>
</div>
...
<h6 class="mb-0 text-uppercase">Tambah Dana Zakat</h6>
<hr />
    ...
    <div class="card-body">
        ...
        <form method="POST" action="#">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="tarikh_dana" name="tarikh_dana" required>
            </div>

            <div class="mb-3">
                <label for="status" class="form-label">Status Dana</label>
                <div class="form-check">
                    <input type="radio" id="aktif" name="status" value="1" class="form-check-input" required>
