    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('student') }}"></i>Senarai Pelajar</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Senarai Pelajar Dipadam</li>
            </ol>
        </nav>
    </div>
</div>
<!--end breadcrumb-->
<h6 class="mb-0 text-uppercase">Senarai Pelajar Dipadam</h6>
<hr />
<div class="card">
    <div class="card-body">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form class="d-inline" method="POST" action="">
                    <a href="{{ route('student') }}" class="btn btn-danger">Padam</a>
                </form>
            </div>
        </div>
    </div>
