    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Tambah Pelajar</li>
            </ol>
        </nav>
    </div>
</div>
...
<h6 class="mb-0 text-uppercase">Tambah Pelajar</h6>
<hr />
        ...
        <form method="POST" action="#">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="position_id" name="position_id">
                    <option value="" disabled selected>Pilih Fakulti</option>
            ...
            <a href="{{ route('student') }}" class="btn btn-primary">Tambah</a>
        </form>
    </div>
</div>
