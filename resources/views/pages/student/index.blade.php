...
<!--end breadcrumb-->
<h6 class="mb-0 text-uppercase">Senarai Pelajar</h6>
<hr />
<div class="card">
    <div class="card-body">
            ...
            <div class="position-relative">
                <form action="#" method="GET" id="searchForm"
                    ...
                    <div class="input-group">
                        ...
                        <a href="{{ route('student') }}" class="btn btn-primary ms-1 rounded" id="searchButton">
                            <i class="bx bx-search"></i>
                        </a>
                        <a href="{{ route('student') }}" class="btn btn-secondary ms-1 rounded" id="resetButton">
                            Reset
                        </a>
                    </div>
                </form>
